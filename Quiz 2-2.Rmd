...
For this question, we want to verify the answer we got for 2a. We expect that for any $\alpha$ we put in, the proportion of trials that will have a high enough $F$ statistic to reject the null hypothesis that $\mu_1 = \mu_2$.
```{r}
#Set seed
set.seed(743358478)
...
```
This comes out to be **0.0501**. This is very close to $\alpha=0.05$ which is exactly what we expect.

**Question 2c**

Just to show my computation hold, I have made a script here instead of writing it by hand.
...
For this question we want to find the power of this test for various values of $\mu_2$. We should expect that as $\mu_2$ gets further away from $\mu_1$, the power increases.
```{r}
#Set seed
set.seed(1269075846)
...
```
This is exactly in line with my prediction. It is very close to the estimation from 2c.

mu  power   estimation
1.1	0.0528	0.05516129		
1.2	0.0668	0.07082135		
1.3	0.0977	0.09742459		
1.4	0.1357	0.13545156		
1.5	0.1800	0.18509566		
1.6	0.2456	0.24593206		
1.7	0.3214	0.31667051		
1.8	0.3985	0.39506921		
1.9	0.4758	0.47805041		
2.0	0.5679	0.56200665	
